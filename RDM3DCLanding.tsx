...
import { ArrowRight, FlaskConical, Cpu, Gamepad2, AppWindow, ShieldCheck, Github, Mail, Twitter, Boxes, Sparkles } from "lucide-react";
...
const divisions = [
  ...
  },
  {
    ...
    title: "Games & Blockchain",
    blurb: "PVGL, science NFT mechanics, verifiable idea tournaments.",
  },
  {
    key: "apps",
    icon: <AppWindow className="h-6 w-6" />,
    title: "Apps",
    blurb: "Ice Cream Truck, Monster Scanner, and realtime geo-aware tools.",
  },
];
...
const projects = [
  ...
  },
  {
    ...
    copy: "Kid‑friendly room scanner that ends with an \"all clear\".",
    cta: "Preview",
    href: "#",
  },
  {
    tag: "Web3",
    title: "PVGL League",
    copy: "Autonomous e-sports league with smart‑contract entry and payouts.",
    cta: "Roadmap",
    href: "#",
  },
  {
    tag: "Civic",
    title: "Ice Cream Truck App",
    copy: "Real‑time driver ↔ customer routing with Firebase + Maps.",
    cta: "Prototype",
    href: "#",
  },
];
