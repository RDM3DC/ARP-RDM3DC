  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-slate-100">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute -top-24 left-1/2 -translate-x-1/2 h-[36rem] w-[36rem] rounded-full bg-gradient-to-tr from-cyan-600/60 via-blue-500/60 to-teal-500/60 blur-3xl" />
        </div>
