  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-slate-100">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute -top-24 left-1/2 -translate-x-1/2 h-[36rem] w-[36rem] rounded-full bg-gradient-to-tr from-fuchsia-600/60 via-violet-500/60 to-pink-500/60 blur-3xl" />
        </div>
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 md:py-28 text-center">
          ...
          >
            Building <span className="text-purple-300">Adaptive</span> Systems that Learn, Align & Ship
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 16 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      <section id="projects" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
        <div className="flex items-end justify-between gap-4">
          ...
          <a className="text-sm text-purple-300 hover:text-white" href="https://github.com/RDM3DC" target="_blank" rel="noreferrer">
          ...
          {projects.map((p, i) => (
            <motion.div key={p.title} initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.04 }}>
              <Card className="group rounded-2xl border-white/10 bg-white/5 hover:bg-white/[0.07] transition-colors">
                <CardHeader>
                  <div className="text-xs uppercase tracking-wide text-purple-300/80">{p.tag}</div>
        ...
        <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-8 md:p-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-3">
              <input className="w-full rounded-xl bg-white/5 border border-white/10 px-4 py-3 outline-none placeholder:text-slate-400 focus:ring-2 focus:ring-purple-400" placeholder="Your name" aria-label="Your name" />
              <input className="w-full rounded-xl bg-white/5 border border-white/10 px-4 py-3 outline-none placeholder:text-slate-400 focus:ring-2 focus:ring-purple-400" placeholder="Email" aria-label="Email" />
              <textarea rows={5} className="w-full rounded-xl bg-white/5 border border-white/10 px-4 py-3 outline-none placeholder:text-slate-400 focus:ring-2 focus:ring-purple-400" placeholder="What would you like to build?" aria-label="Project description" />
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-slate-100">
      ...
      <header className="sticky top-0 z-50 backdrop-blur supports-[backdrop-filter]:bg-slate-950/60 border-b border-white/5">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="h-8 w-8 rounded-xl bg-gradient-to-tr from-fuchsia-500 via-violet-400 to-pink-400 grid place-items-center shadow-lg shadow-purple-500/20">
      ...
      <section id="contact" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20">
        <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-8 md:p-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-3">
              <input className="w-full rounded-xl bg-white/5 border border-white/10 px-4 py-3 outline-none placeholder:text-slate-400 focus:ring-2 focus:ring-purple-400" placeholder="Your name" />
              <input className="w-full rounded-xl bg-white/5 border border-white/10 px-4 py-3 outline-none placeholder:text-slate-400 focus:ring-2 focus:ring-purple-400" placeholder="Email" />
              <textarea rows={5} className="w-full rounded-xl bg-white/5 border border-white/10 px-4 py-3 outline-none placeholder:text-slate-400 focus:ring-2 focus:ring-purple-400" placeholder="What would you like to build?" />
              <Button className="rounded-2xl w-full">Send message</Button>
            </div>
          </div>
        </div>
